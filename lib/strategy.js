...
function Strategy(options, verify) {
  options = options || {};
  options.name = options.name || 'citrix-auth-service';
  options.profileURL = options.profileURL || 'https://account.citrixonline.com/identity/v1/Users/me';
  options.authorizationURL = options.authorizationURL || 'https://authentication.citrixonline.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://authentication.citrixonline.com/oauth/token';
 ...
 *
 *   - `provider`         always set to `citrix-auth-service`
 *
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(userProfileURL, accessToken, function (err, body, res) {
    ...
    var profile = json;
    profile.provider  = 'citrix-auth-service';
    profile._raw = body;
    profile._json = json;
